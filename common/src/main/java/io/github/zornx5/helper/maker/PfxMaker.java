...
public class PfxMaker {
     ...
     * @throws PKCSException            PKCS 异常
     */
    public PKCS12PfxPdu makePfx(PrivateKey privateKey, PublicKey publicKey, X509Certificate[] chain, String password)
     ...
     * @throws PKCSException            PKCS 异常
     */
    public PKCS12PfxPdu makePfx(PrivateKey privateKey, PublicKey publicKey, X509Certificate certificate, String password)
            throws NoSuchAlgorithmException, IOException, PKCSException {
        JcaX509ExtensionUtils extUtils = new JcaX509ExtensionUtils();

        PKCS12SafeBagBuilder eeCertBagBuilder = new JcaPKCS12SafeBagBuilder(certificate);
        eeCertBagBuilder.addBagAttribute(PKCSObjectIdentifiers.pkcs_9_at_friendlyName,
                new DERBMPString("User Key"));
        eeCertBagBuilder.addBagAttribute(PKCSObjectIdentifiers.pkcs_9_at_localKeyId,
                extUtils.createSubjectKeyIdentifier(publicKey));
